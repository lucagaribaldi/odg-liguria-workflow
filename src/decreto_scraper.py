...
class DecretoScraper:
    ...
    def __init__(self, base_url: str = "https://decretidigitali.regione.liguria.it", 
                 rate_limit: float = 1.0, max_retries: int = 3, timeout: int = 30):
        """
    ...
    def verify_decreto_publication(self, seduta: str, numero: str, oggetto: str, 
                                  data_seduta: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def _search_by_numero_and_date(self, seduta: str, numero: str, oggetto: str, 
                                   data_seduta: Optional[str] = None) -> Dict[str, Any]:
        """Search decreto by number and session date."""
        self.logger.debug(f"Searching by numero {numero} and date {data_seduta}")
        
        result = {'found': False, 'url': None, 'data_pubblicazione': None, 'dgr_numero': None, 'dgr_anno': None}
    ...
    def _search_by_oggetto_and_date(self, seduta: str, numero: str, oggetto: str, 
                                   data_seduta: Optional[str] = None) -> Dict[str, Any]:
    ...
    def _search_by_numero(self, seduta: str, numero: str, oggetto: str, 
                         data_seduta: Optional[str] = None) -> Dict[str, Any]:
    ...
    def _search_by_oggetto(self, seduta: str, numero: str, oggetto: str) -> Tuple[bool, Optional[str]]:
    ...
    def _search_by_seduta_and_numero(self, seduta: str, numero: str, oggetto: str) -> Tuple[bool, Optional[str]]:
        ...
        try:
            ...
            response = self._make_request(f"{self.base_url}/ricerca", params)
            if response:
                return self._parse_search_results(response, numero, oggetto)
    ...
    def _parse_search_results(self, response: requests.Response, numero: str, oggetto: str) -> Tuple[bool, Optional[str]]:
    ...
    def _extract_key_terms(self, oggetto: str) -> list:
        ...
        stop_words = {
            'di', 'da', 'in', 'con', 'su', 'per', 'tra', 'fra', 'a', 'e', 'il', 'lo', 'la', 'i', 'gli', 'le',
    ...
    def _parse_search_results_enhanced(self, response: requests.Response, numero: str, oggetto: str) -> Dict[str, Any]:
